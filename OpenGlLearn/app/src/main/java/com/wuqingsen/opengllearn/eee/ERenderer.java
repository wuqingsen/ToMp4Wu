package com.wuqingsen.opengllearn.eee;
...
public class ERenderer implements GLSurfaceView.Renderer {
    ...
    public ERenderer(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //1.读取顶点着色器
        String vertexShaderSource = TextResourceReader.readTextFileFromResource(context, R.raw.e_vertex_shader);
        //读取片段着色器
        String fragmentShaderSource = TextResourceReader.readTextFileFromResource(context, R.raw.e_fragment_shader);
